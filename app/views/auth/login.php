        ...
        <div class="bg-white rounded-lg shadow-md p-8 max-w-md w-full">
            ...
            <form action="/login" method="POST" data-validate>
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="/register" class="text-sm text-green-600 hover:text-green-800">Belum punya akun? Daftar</a>
                </div>
            </form>
            
            <div class="mt-6 pt-6 border-t border-gray-200 text-center text-sm text-gray-600">
                <p>RT Management System &copy; 2023</p>
                <div class="mt-2 flex justify-center space-x-2">
                    <button id="install-btn" class="hidden text-xs bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-1 px-2 rounded transition-colors">
                        Install App
                    </button>
                    <button id="notification-btn" class="text-xs bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-1 px-2 rounded transition-colors">
                        Izinkan Notifikasi
                    </button>
                </div>
            </div>
