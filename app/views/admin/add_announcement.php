                ...
                <div class="p-6">
                    ...
                    <form action="/admin/announcement/add" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content" name="content" rows="6" class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md" required><?php echo isset($old['content']) ? htmlspecialchars($old['content']) : ''; ?></textarea>
                        </div>
