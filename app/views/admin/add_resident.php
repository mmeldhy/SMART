...
<head>
    ...
    <title>Tambah Warga - RT Management System</title>
        ...
        <main class="flex-1 p-4 md:p-6 overflow-y-auto">
            <div class="max-w-3xl mx-auto">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-800">Tambah Warga</h1>
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <form action="/admin/resident/add" method="POST" data-validate>
                        <div class="p-6 space-y-6">
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="username" id="username" class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="phone" id="phone" class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                </div>
                            </div>
                            <div>
                                <label for="address" class="block text-sm font-medium text-gray-700">Alamat</label>
                                <textarea name="address" id="address" rows="3" class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required></textarea>
                            </div>
                        </div>
