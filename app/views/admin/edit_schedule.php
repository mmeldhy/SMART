                ...
                <div class="p-6">
                    ...
                    <form action="/admin/schedule/edit/<?php echo $schedule['id']; ?>" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="schedule_date" name="schedule_date" value="<?php echo isset($schedule['date']) ? date('Y-m-d', strtotime($schedule['date'])) : ''; ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                        </div>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label for="schedule_time" class="block text-sm font-medium text-gray-700 mb-1">Time</label>
                                <input type="time" id="schedule_time" name="schedule_time" value="<?php echo isset($schedule['start_time']) ? date('H:i', strtotime($schedule['start_time'])) : ''; ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                            </div>
